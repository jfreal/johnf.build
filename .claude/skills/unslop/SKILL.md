---
name: unslop
description: Cut AI tells from prose written for human readers: blog posts, docs,
  READMEs, marketing copy, PR bodies, release notes. Always apply before that writing
  ships. Not for code, commit messages, log output, or quoted source material.
---
...
These moves restore a voice the writing already has. They do not install one it never
had. Neutral technical copy stays neutral. Don't add opinions, first-person, or emotional
framing to a reference page or an API doc just to make it sound human.
Step 2 of the process wins. Preserve meaning, match intended tone.
...
7. **Unsupported numbers.** Every number is a claim someone can check. If a statistic, count, date, or percentage has no source in the material you were given, cut it. Never invent a replacement figure, and never round a made-up number to make it look researched. "On a good month" beats a confident number you can't back.
